        ...
        <div class="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden" id="example-collapse-sidebar">
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
              ...
              <li class="items-center hover:bg-gray-100">
                <a href="clientes.php" class="hover:text-pink-600 text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"><i class="fas fa-newspaper text-blueGray-400 mr-2 text-sm"></i>
                  Clientes</a>
              </li>
              <li class="items-center hover:bg-gray-100">
                <a href="ganancias.php" class="hover:text-pink-600 text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"><i class="fas fa-user-circle text-blueGray-400 mr-2 text-sm"></i>
                  Ganancias</a>
              </li>
              <li class="items-center hover:bg-gray-100">
                <a href="historial.php" id="empleadosLink" class="hover:text-pink-600 text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"><i class="fas fa-fingerprint text-blueGray-400 mr-2 text-sm"></i>
                  Historial</a>
              </li>
              <li class="items-center hover:bg-gray-100">
                <a href="membresias.php" class="hover:text-pink-600 text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"><i class="fas fa-fingerprint text-blueGray-400 mr-2 text-sm"></i>
                  Membresias</a>
              </li>
            </ul>
